...
<head>
    ...
    <style>
    .headercontainer {
        background-image: url('img/bgsurabaya.png');
...
<body>
    ...
    <div class="event-container" id="event">
        ...
        // Function to fetch and display events from Surabaya
        function fetchEventsFromSurabaya()
        {
            global $conn;
        ...
        // Display events from Surabaya
        fetchEventsFromSurabaya();
        ?>
    </div>
</body>
