...
<head>
    ...
    <style>
    .headercontainer {
        background-image: url('img/bgbali.png');
...
<body>
    ...
    <div class="event-container" id="event">
        ...
        // Function to fetch and display events from Bali
        function fetchEventsFromBali()
        {
            global $conn;
            ...
            if ($result) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<p class="event-description-' . $counter . '">Description: ' . $row['deskripsi'] . '</p>';
