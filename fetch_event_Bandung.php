...
<head>
    ...
    <style>
    .headercontainer {
        background-image: url('img/bgbandung.png');
...
<body>
    ...
    <div class="event-container" id="event">
        ...
        // Function to fetch and display events from Bandung
        function fetchEventsFromBandung()
        {
            global $conn;
        ...
        // Display events from Bandung
        fetchEventsFromBandung();
        ?>
    </div>
</body>
